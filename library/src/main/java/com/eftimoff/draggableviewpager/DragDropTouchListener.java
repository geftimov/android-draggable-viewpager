...
//		mobileView.bringToFront();
	...
	private void changePageIfNeeded(int currentX) {
		...
		if (currentX <= maximumOffset || displayMetrics.widthPixels - currentX <= maximumOffset) {
			Log.i("!!!!!!!!!!!!!!!!!!!!!!!!!", " ZONATA");
		}
	}
	...
	protected abstract void swipePageLeft();


	protected abstract void swipePageRight();
